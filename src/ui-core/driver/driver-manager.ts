...
import { Config } from '../interfaces/structures/config.structure';
import { DriverManagerActions } from './driver-manager.actions';

let config: Config = require('../../../playwright.config.json');

export class DriverManager implements DriverManagerActions{
